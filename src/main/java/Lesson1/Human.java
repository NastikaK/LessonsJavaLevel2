...
public class Human implements Contestant {
    ...
    public Human(String name, double runLength, double jumpHeight) {
        this.name = name;
    ...
    public void run() {
        System.out.print("Человек " + name + " бежит: ");
    }

    public void jump() {
        System.out.print("Человек " + name + " прыгает: ");
    }
    ...
    public boolean canJump(double height) {
        ...
        if (canJump) {
            ...
            System.out.println("Максимальные возможности человека " + name + " " + maxHeight + " м.");
        }
        return canJump;
    }
}
